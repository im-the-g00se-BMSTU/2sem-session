...
%% 1: че реально кто-то будет это учить? %% %% 2: А есть другие варианты??? %% %% 1: я о том, что вряд ли будут требовать реализацию алгоритмов обработки %% %% 2: А мне кажется вполне, потому что это второй рк%% %% 1: ну разве что в контексте практической задачи%% 
